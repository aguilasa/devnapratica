 ...
 * Trabalho Final
 */
public class CreateBulkItemListImpl {
	...
	public CreateBulkItemListImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkItemListInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_ITEM_LIST, //
	...
	*/
	public CreateBulkItemListOutput createBulkItemList(CreateBulkItemListInput input, long timeout) {
		...
		CreateBulkItemListOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkItemListOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkItemListOutput> createBulkItemListRequest(CreateBulkItemListInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkItemListOutput.class);
	}
