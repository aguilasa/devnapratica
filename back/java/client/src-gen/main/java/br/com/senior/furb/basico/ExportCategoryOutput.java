...
public class ExportCategoryOutput {
    
    public String exportJobId;
    
    public ExportCategoryOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportCategoryOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportCategoryOutput)) {
            return false;
        }
        ExportCategoryOutput other = (ExportCategoryOutput) obj;
