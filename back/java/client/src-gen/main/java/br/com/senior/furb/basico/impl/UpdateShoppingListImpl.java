 ...
 * Trabalho Final
 */
public class UpdateShoppingListImpl {
	...
	public UpdateShoppingListImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(ShoppingList input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				BasicoConstants.Commands.UPDATE_SHOPPING_LIST, //
