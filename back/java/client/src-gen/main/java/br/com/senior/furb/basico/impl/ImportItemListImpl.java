 ...
 * Trabalho Final
 */
public class ImportItemListImpl {
	...
	public ImportItemListImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ImportItemListInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.IMPORT_ITEM_LIST, //
	...
	*/
	public ImportItemListOutput importItemList(ImportItemListInput input, long timeout) {
		...
		ImportItemListOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ImportItemListOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ImportItemListOutput> importItemListRequest(ImportItemListInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportItemListOutput.class);
	}
