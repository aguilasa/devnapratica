...
public class ImportItemListOutput {
    
    public String importJobId;
    
    public ImportItemListOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportItemListOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportItemListOutput)) {
            return false;
        }
        ImportItemListOutput other = (ImportItemListOutput) obj;
