...
public class ItemListDto {
     ...
     */
    public ItemListDto(String id, ProductDto product, Double quantity, Double price, Boolean checked, String note) {
        this.id = id;
     ...
     */
    public ItemListDto(ProductDto product, Double quantity, Double price) {
        this.product = product;
        this.quantity = quantity;
        this.price = price;
    }
