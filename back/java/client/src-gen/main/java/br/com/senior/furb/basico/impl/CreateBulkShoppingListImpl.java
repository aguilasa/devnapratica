 ...
 * Trabalho Final
 */
public class CreateBulkShoppingListImpl {
	...
	public CreateBulkShoppingListImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkShoppingListInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_SHOPPING_LIST, //
	...
	*/
	public CreateBulkShoppingListOutput createBulkShoppingList(CreateBulkShoppingListInput input, long timeout) {
		...
		CreateBulkShoppingListOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkShoppingListOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkShoppingListOutput> createBulkShoppingListRequest(CreateBulkShoppingListInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkShoppingListOutput.class);
	}
