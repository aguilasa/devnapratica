...
public class ItemList {
     ...
     */
    public ItemList(String id, String description, Double quantity, Unit unit, Double price, Category category, String note) {
        this.id = id;
     ...
     */
    public ItemList(String description, Double quantity, Unit unit, Double price, Category category) {
        this.description = description;
        this.quantity = quantity;
        this.unit = unit;
        this.price = price;
