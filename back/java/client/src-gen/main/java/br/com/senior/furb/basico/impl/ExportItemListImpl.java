 ...
 * Trabalho Final
 */
public class ExportItemListImpl {
	...
	public ExportItemListImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportItemListInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.EXPORT_ITEM_LIST, //
	...
	*/
	public ExportItemListOutput exportItemList(ExportItemListInput input, long timeout) {
		...
		ExportItemListOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportItemListOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ExportItemListOutput> exportItemListRequest(ExportItemListInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportItemListOutput.class);
	}
