...
public class ExportProductOutput {
    ...
    public ExportProductOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportProductOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportProductOutput)) {
            return false;
        }
        ExportProductOutput other = (ExportProductOutput) obj;
