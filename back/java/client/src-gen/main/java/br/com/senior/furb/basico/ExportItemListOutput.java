...
public class ExportItemListOutput {
    
    public String exportJobId;
    
    public ExportItemListOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportItemListOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportItemListOutput)) {
            return false;
        }
        ExportItemListOutput other = (ExportItemListOutput) obj;
