...
public class ImportCategoryOutput {
    
    public String importJobId;
    
    public ImportCategoryOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportCategoryOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportCategoryOutput)) {
            return false;
        }
        ImportCategoryOutput other = (ImportCategoryOutput) obj;
