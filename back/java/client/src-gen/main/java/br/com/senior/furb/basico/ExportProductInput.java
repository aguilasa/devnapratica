...
public class ExportProductInput {
    ...
    public ExportProductInput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportProductInput(ExportConfig config) {
        this.config = config;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportProductInput)) {
            return false;
        }
        ExportProductInput other = (ExportProductInput) obj;
