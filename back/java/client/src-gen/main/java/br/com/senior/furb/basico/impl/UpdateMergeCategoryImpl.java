 ...
 * Trabalho Final
 */
public class UpdateMergeCategoryImpl {
	...
	public UpdateMergeCategoryImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Category input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				BasicoConstants.Commands.UPDATE_MERGE_CATEGORY, //
