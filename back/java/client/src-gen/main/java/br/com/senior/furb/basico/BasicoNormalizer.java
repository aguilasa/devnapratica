...
public class BasicoNormalizer {
    ...
    /**
     * Normalizes the Category payload.
     */
    public static void normalize(Category toNormalize, Map<String, Object> headers) {
    	if (headers != null) {
    ...
    /**
     * Normalizes the Category.Id payload.
     */
    public static void normalize(Category.Id toNormalize, Map<String, Object> headers) {
    	if (headers != null) {
    		String entityId = headers.containsKey(Message.ENTITY_ID_HEADER) ? headers.get(Message.ENTITY_ID_HEADER).toString() : null;
    		if (entityId != null && toNormalize != null && toNormalize.id == null) {
    			toNormalize.id = entityId;
    ...
    /**
     * Normalizes the ItemList.Id payload.
     */
    public static void normalize(ItemList.Id toNormalize, Map<String, Object> headers) {
    	if (headers != null) {
    		String entityId = headers.containsKey(Message.ENTITY_ID_HEADER) ? headers.get(Message.ENTITY_ID_HEADER).toString() : null;
    		if (entityId != null && toNormalize != null && toNormalize.id == null) {
    			toNormalize.id = entityId;
    ...
    /**
     * Normalizes the ShoppingList payload.
     */
    public static void normalize(ShoppingList toNormalize, Map<String, Object> headers) {
    	if (headers != null) {
    		String entityId = headers.containsKey(Message.ENTITY_ID_HEADER) ? headers.get(Message.ENTITY_ID_HEADER).toString() : null;
    		if (entityId != null && toNormalize != null && toNormalize.id == null) {
    			toNormalize.id = entityId;
    ...
    /**
     * Normalizes the ShoppingList.Id payload.
     */
    public static void normalize(ShoppingList.Id toNormalize, Map<String, Object> headers) {
    	if (headers != null) {
    		String entityId = headers.containsKey(Message.ENTITY_ID_HEADER) ? headers.get(Message.ENTITY_ID_HEADER).toString() : null;
    		if (entityId != null && toNormalize != null && toNormalize.id == null) {
    			toNormalize.id = entityId;
