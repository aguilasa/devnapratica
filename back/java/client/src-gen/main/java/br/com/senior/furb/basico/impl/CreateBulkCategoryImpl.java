 ...
 * Trabalho Final
 */
public class CreateBulkCategoryImpl {
	...
	public CreateBulkCategoryImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkCategoryInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_CATEGORY, //
	...
	*/
	public CreateBulkCategoryOutput createBulkCategory(CreateBulkCategoryInput input, long timeout) {
		...
		CreateBulkCategoryOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkCategoryOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkCategoryOutput> createBulkCategoryRequest(CreateBulkCategoryInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkCategoryOutput.class);
	}
