...
public class ImportProductOutput {
    
    public String importJobId;
    
    public ImportProductOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportProductOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportProductOutput)) {
            return false;
        }
        ImportProductOutput other = (ImportProductOutput) obj;
