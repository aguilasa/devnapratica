 ...
 * Trabalho Final
 */
public class UpdateMergeShoppingListImpl {
	...
	public UpdateMergeShoppingListImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ShoppingList input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.UPDATE_MERGE_SHOPPING_LIST, //
	...
	*/
	public ShoppingList updateMergeShoppingList(ShoppingList input, long timeout) {
		...
		ShoppingList output = DtoJsonConverter.toDTO(resultMessage.getContent(), ShoppingList.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ShoppingList> updateMergeShoppingListRequest(ShoppingList input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ShoppingList.class);
	}
