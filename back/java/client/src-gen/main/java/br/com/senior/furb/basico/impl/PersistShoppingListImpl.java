 ...
 * Trabalho Final
 */
public class PersistShoppingListImpl {
	...
	public PersistShoppingListImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(PersistShoppingListInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.PERSIST_SHOPPING_LIST, //
	...
	*/
	public PersistShoppingListOutput persistShoppingList(PersistShoppingListInput input, long timeout) {
		...
		PersistShoppingListOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), PersistShoppingListOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<PersistShoppingListOutput> persistShoppingListRequest(PersistShoppingListInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, PersistShoppingListOutput.class);
	}
