 ...
 * Trabalho Final
 */
public class ListShoppingListImpl {
	...
	public ListShoppingListImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ShoppingList.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.LIST_SHOPPING_LIST, //
	...
	*/
	public ShoppingList.PagedResults listShoppingList(ShoppingList.PageRequest input, long timeout) {
		...
		ShoppingList.PagedResults output = DtoJsonConverter.toDTO(resultMessage.getContent(), ShoppingList.PagedResults.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ShoppingList.PagedResults> listShoppingListRequest(ShoppingList.PageRequest input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ShoppingList.PagedResults.class);
	}
